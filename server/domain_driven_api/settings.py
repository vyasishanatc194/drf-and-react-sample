"""
Django settings for domain driven api project.
...
from domain_driven_api.infrastructure.logger.services import (
...
INSTALLED_APPS = [
    ...
    "django_pgviews",
    # app modules
    "domain_driven_api.domain.document",
    "widget_tweaks",
]
...
MIDDLEWARE = [
    ...
    "domain_driven_api.infrastructure.middlewares.api_response_middleware.CustomResponseMiddleware",
    "corsheaders.middleware.CorsMiddleware",
]

ROOT_URLCONF = "domain_driven_api.interface.urls"
TEMPLATES = [
    {
...
WSGI_APPLICATION = "domain_driven_api.drivers.wsgi.application"
...
ALLOWED_PROFILE_PICTURE_FILE_EXTENSIONS = os.getenv(
    "ALLOWED_PROFILE_PICTURE_FILE_EXTENSIONS"
).split(",")

ALLOWED_MAX_PROFILE_PICTURE_FILE_SIZE_IN_KB = int(
    os.getenv("ALLOWED_MAX_PROFILE_PICTURE_FILE_SIZE_IN_KB")
)
...
# Cookie transmitting with HttpOnly and secure flag
SESSION_COOKIE_SECURE = bool(int(os.getenv("SESSION_COOKIE_SECURE", 0)))
SESSION_COOKIE_HTTPONLY = bool(int(os.getenv("SESSION_COOKIE_HTTPONLY", 0)))

CSRF_COOKIE_SECURE = bool(int(os.getenv("CSRF_COOKIE_SECURE", 0)))
CSRF_COOKIE_HTTPONLY = bool(int(os.getenv("CSRF_COOKIE_HTTPONLY", 0)))
